...
static int __init proc_cmdline_init(void)
{
	...
	if (strstr(new_command_line, "androidboot.mode=usb_chg")) {
		remove_flag(new_command_line, "androidboot.mode=");
		strcat(new_command_line, " androidboot.mode=charger");
	} else {
		if (strstr(new_command_line, "androidboot.bootreason=usb_chg")) {
			strcat(new_command_line, " androidboot.mode=charger");
		}
	}
